...
from sqlalchemy import ForeignKey, CHAR, Date, DateTime, Integer, String, Text
...
class UserInvitations(BaseModel):
    ...
    # invitation_id : CHAR(36) COLLATE "utf8mb4_unicode_ci"
    invitation_id: Mapped[str] = mapped_column(CHAR(36), primary_key=True, nullable=False)
    ...
    invited_by: Mapped[str] = mapped_column(CHAR(36), ForeignKey("users.user_id", ondelete="CASCADE"), nullable=False)
    ...
    # accepted_by : CHAR(36) COLLATE "utf8mb4_unicode_ci"
    accepted_by: Mapped[Optional[str]] = mapped_column(CHAR(36), ForeignKey("users.user_id", ondelete="SET NULL"))
