...
class RefmSubscriptionStatus(BaseModel):
    __tablename__ = 'refm_subscription_status'
...
class RefmSubscriptionStatusConstants:
    ACTIVE = 'ACTV'
    EXPIRED = 'EXPD'
    CANCELLED = 'CNCL'

class RefmSubscriptionStatusEnum(str, PyEnum):
    ACTIVE = RefmSubscriptionStatusConstants.ACTIVE
    EXPIRED = RefmSubscriptionStatusConstants.EXPIRED
    CANCELLED = RefmSubscriptionStatusConstants.CANCELLED
