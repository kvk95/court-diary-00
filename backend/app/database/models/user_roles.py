...
from sqlalchemy import ForeignKey, BigInteger, Boolean, Date, DateTime, Integer
...
class UserRoles(BaseModel):
    ...
    # start_date : DATE
    start_date: Mapped[Optional[date]] = mapped_column(Date, server_default=func.curdate())
