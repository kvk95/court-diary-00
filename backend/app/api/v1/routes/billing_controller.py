...
#     BillCreate, BillDelete, BillDetailOut, BillEdit, BillListOut,
#     BillSummaryStats, DocumentCreate, DocumentEdit, DocumentOut,
#     PaymentCreate, PaymentDelete, PaymentOut,
# )
...
#         self,
#         service: BillingService = Depends(get_billing_service),  # read enforced in factory
...
#         dependencies=[Depends(require_permission(_BILL, permission=PType.DELETE))],
#     )
